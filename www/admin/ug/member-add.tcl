# $Id: member-add.tcl,v 3.0.4.1 2000/04/28 15:09:33 carsten Exp $
...
ns_write "[ad_admin_header "Add Member"]
...
[export_entire_form]
<input type=hidden name=target value=\"/admin/ug/member-add-2.tcl\">
