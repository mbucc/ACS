...
<tr><td>Variables</td><td><input type=text name=variables size=30 value=\"[philg_quote_double_quotes $variables]\"> <a href=\"variables\">Note on variables</a></td></tr>
...
append doc_body "<p>
\[<a href=\"/admin/ecommerce/audit?[export_url_vars audit_name audit_id audit_id_column return_url audit_tables main_tables]\">Audit Trail</a>\]
