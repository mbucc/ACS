# /www/intranet/facilities/ae.tcl
...
ad_page_contract {
    ...
    @cvs-id ae.tcl,v 1.4.2.11 2001/01/12 08:26:54 khy Exp
} {
...
if { [exists_and_not_null facility_id] } {
    ...
    set context_bar [ad_context_bar_ws [list ./ "Facilities"] [list "view?facility_id=$caller_facility_id" "One facility"] $page_title]

} else {
    set page_title "Add facility"
    set context_bar [ad_context_bar_ws [list ./ "Facilities"] $page_title]
    set public_p f
    set caller_facility_id [db_nextval im_facilities_seq]
 

}
set facility_id $caller_facility_id

set page_body "
<form method=post action=ae-2>
[export_form_vars -sign facility_id]
