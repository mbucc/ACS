# /www/admin/ecommerce/orders/items-void.tcl
ad_page_contract {
...
[ad_admin_context_bar [list "../" "Ecommerce"] [list "index" "Orders"] [list "one?[export_url_vars order_id]" "One Order"] "$item_or_items"]
