# /www/admin/ecommerce/orders/refunds.tcl
ad_page_contract {
  View refunds.
...
[ad_admin_context_bar [list "../" "Ecommerce"] [list "index" "Orders"] "Refund History"]
...
<td>$n_items</td>
<td><a href=\"/admin/users/one?user_id=$refunded_by\">$last_name, $first_names</a></td></tr>
    "
    incr row_counter
}
