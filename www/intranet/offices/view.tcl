...
if { $empty_string_p==0 } {
    ...
    if { $group_exists_p } {	
	set context_bar [ad_context_bar_ws [list ./ "Offices"] "One office"]
	doc_return  200 text/html "
[im_header "No office information"]
You have to enter <a href=ae?[export_url_vars group_id]>office specific information</a> to continue.
[im_footer]
"
        return
    }
...
<tr>
  <th></th>
  <td valign=top>(<a href=ae?group_id=$caller_group_id&[export_url_vars return_url]>edit</A>)</td>
</tr>
...
<tr>
  <th></th>
  <td align=center>(<a href=/intranet/facilities/ae?facility_id=$facility_id&[export_url_vars return_url]>edit</A>)</td>
</tr>
...
db_foreach intranet_offices_get_links_loop $sql_query {
    ...
    append links "  <li> <a href=\"$url\">$link_title</a> (<a href=link-ae?[export_url_vars group_id link_id]>edit</a>)\n"
}
...
<p><li><a href=link-ae?[export_url_vars group_id]>Add a link</a>
"
