# $Id: add-complete-css-property-2.tcl,v 3.0 2000/02/06 03:16:21 ron Exp $
# File:     /admin/css/add-complete-css-property-2.tcl
# Date:     12/26/99
# Author:   ahmeds@arsdigita.com
# Purpose:  setting up cascaded style sheet properties of a chosen selector
#
...
if {![info exists selector] || [empty_string_p $selector] } {
    incr exception_count
    append exception_text "<li>No selector was supplied."
}
