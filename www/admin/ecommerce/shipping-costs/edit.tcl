# $Id: edit.tcl,v 3.0 2000/02/06 03:21:30 ron Exp $
...
if { [info exists base_shipping_cost] && ![empty_string_p $base_shipping_cost] && [regexp {[^0-9\.]} $base_shipping_cost] } {
...
if { [info exists default_shipping_per_item] && ![empty_string_p $default_shipping_per_item] && [regexp {[^0-9\.]} $default_shipping_per_item] } {
    incr exception_count
...
if { [info exists weight_shipping_cost] && ![empty_string_p $weight_shipping_cost] && [regexp {[^0-9\.]} $weight_shipping_cost] } {
    incr exception_count
...
if { [info exists add_exp_base_shipping_cost] && ![empty_string_p $add_exp_base_shipping_cost] && [regexp {[^0-9\.]} $add_exp_base_shipping_cost] } {
    incr exception_count
...
if { [info exists add_exp_amount_per_item] && ![empty_string_p $add_exp_amount_per_item] && [regexp {[^0-9\.]} $add_exp_amount_per_item] } {
    incr exception_count
...
if { [info exists add_exp_amount_by_weight] && ![empty_string_p $add_exp_amount_by_weight] && [regexp {[^0-9\.]} $add_exp_amount_by_weight] } {
    incr exception_count
...
ns_write "[ad_admin_header "Confirm Shipping Costs"]
