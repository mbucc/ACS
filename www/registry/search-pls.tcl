# $Id: search-pls.tcl,v 3.0 2000/02/06 03:54:17 ron Exp $
set use_context_p 0
...
ns_write "[ad_header "Full Text Search Results"]

<h2>Search Results</h2>

for \"$query_string\" into the <a href=index.tcl>Stolen Equipment Registry</a>
