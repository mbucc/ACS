...
set list_of_group_types [list \
	[list [im_office_group_id] "office" "[im_url_stub]/offices/ae?[export_url_vars return_url]" "[im_url_stub]/offices/view"] \
	[list [im_team_group_id] "team" $add_team_href ""] \
	[list [im_project_group_id] "project" "[im_url_stub]/projects/ae?[export_url_vars return_url]" "[im_url_stub]/projects/view"] \
	[list [im_customer_group_id] "customer" "[im_url_stub]/customers/ae?[export_url_vars return_url]" "[im_url_stub]/customers/view"]]
...
set context_bar [ad_context_bar_ws [list ./ "Employees"] "One employee"]
