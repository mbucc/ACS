# /www/admin/ecommerce/audit-one-id.tcl
ad_page_contract {
...
[ad_admin_context_bar [list index Ecommerce] [list "audit-tables?[export_url_vars table_names_and_id_column]" "Audit $main_table_name"] "[ec_system_name] Audit Trail"]
<hr>

<h3>$main_table_name</h3>
<blockquote>

[ad_audit_trail $id $audit_table_name $main_table_name $id_column]
