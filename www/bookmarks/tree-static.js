...
{ 
  ...
  { 
	...
	if (this.id>0)
	{
		doc.write("<font size=-1 color=#000066 face=arial,helvetica>"+this.decoration+this.desc + "</a> (<a href=edit-bookmark.tcl?return_url=tree-frame.tcl&bookmark_id="+this.key+">edit</a>)")
	} else {
...
{ 
  ...
  if (USETEXTLINKS) 
    doc.write("<font size=-1 face=arial,helvetica><a href=" + this.link + ">" +this.decoration + this.desc + "</a> (<a href=edit-bookmark.tcl?return_url=tree-frame.tcl&bookmark_id="+this.key+">edit</a>)")
  else 
    doc.write(this.desc) 
  doc.write("</table>") 
