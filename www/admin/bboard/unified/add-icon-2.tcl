# /www/admin/bboard/unified/add-icon-2.tcl
ad_page_contract {
    Processes the addition of an icon
    ...
    @param img_name a name to give the icon
    @param img_h the height of the icon
    @param img_w the width of the icon

    @author LuisRodriguez@photo.net
    @creation-date May 2000
    @cvs-id add-icon-2.tcl,v 1.2.2.4 2000/08/06 21:56:23 kevin Exp
} { 
...
# this stuff only makes sense to do if we know upload_file exists
...
page_validation {
	...
	error "Sorry, no IconDir directory was specified as a publishing option as the place to store more icons.  You can usually solve this problem by editing the parameters/yourserver.ini file, then restarting the aolserver."
    }
...
# To standardize, try to set the file extension if it is a jpg or gif
