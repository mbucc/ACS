...
set sql_query "select stage, checkpoint, checkpoint_id, 
               (select count(*) from im_emp_checkpoint_checkoffs, im_employee_info
               where im_emp_checkpoint_checkoffs.checkee(+) = im_employee_info.user_id
...
set context_bar [ad_context_bar_ws [list "[im_url_stub]/reports/" "Reports"] "Missing Checkpoints"]
