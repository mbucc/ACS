...
ad_library {
    ...
    @cvs-id api-documentation-procs.tcl,v 1.1.4.9 2000/07/28 14:43:49 lars Exp
...
ad_proc -private api_set_public { version_id } {
    set public_property_name "api,package,$version_id,public_p"
    if { [empty_string_p [ns_queryget public_p]] } {
	set public_p [ad_get_client_property "acs-core" $public_property_name]
	if { [empty_string_p $public_p] } {
	    set public_p 0
	}
	ns_set update [ns_getform] public_p $public_p
    } else {
	ad_set_client_property -deferred t "acs-core" $public_property_name [ns_queryget public_p]
    }
}
