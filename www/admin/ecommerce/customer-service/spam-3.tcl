...
ad_page_contract { 
    ...
    @param ora_start_date:optional
    @param ora_end_date:optional
    ...
    @author
    @creation-date
    @cvs-id spam-3.tcl,v 3.2.2.10 2001/01/15 20:02:31 kevin Exp
} { 
    spam_id:notnull
    ...
    product_id:optional
    ora_start_date:optional
    ora_end_date:optional
...
if { [info exists user_id_list] } {
    ...
    set users_query "select users.user_id as user_id, email from users, ec_cat_mailing_lists where users.user_id=ec_cat_mailing_lists.user_id and $search_criteria"
...
if { ![info exists ora_start_date] } {
    set ora_start_date ""
}
if { ![info exists ora_end_date] } {
    set ora_end_date ""
}
...
db_transaction {
    ...
    values
        (:spam_id, :message, :mailing_list_category_id, 
         :mailing_list_subcategory_id, :mailing_list_subsubcategory_id, 
         :user_class_id, :product_id, 
         to_date(:ora_start_date,'YYYY-MM-DD HH24:MI:SS'), 
         to_date(:ora_end_date,'YYYY-MM-DD HH24:MI:SS'))
    "
