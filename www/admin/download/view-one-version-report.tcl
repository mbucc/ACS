# $Id: view-one-version-report.tcl,v 3.1 2000/02/15 02:07:19 ahmeds Exp $
# File:     /admin/download/view-one-version-report.tcl
# Date:     01/04/2000
...
<h2>$page_title</h2>
[ad_admin_context_bar [list "index.tcl?[export_url_vars]" "Download"]  [list "view-versions.tcl?[export_url_vars]&download_id=$did " "$download_name Versions"] "View Report"]
...
<th  align=center>[ad_space 2] IP Address[ad_space 2]  </th>
