# packages/acs-core/server-cluster-procs.tcl
ad_library {
    Provides methods for communicating between load-balanced servers.
    
    @cvs-id server-cluster-procs.tcl,v 1.1.4.1 2000/07/08 03:59:24 lars Exp
...
proc_doc ad_canonical_server_p {} { Returns true if this is the primary server, false otherwise. } {
    ...
    set canonical_server [ad_parameter CanonicalServer server-cluster]
