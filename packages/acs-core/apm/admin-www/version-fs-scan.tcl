ad_page_contract { 
    ...
    @date 9 May 2000
    @cvs-id version-fs-scan.tcl,v 1.4.2.3 2000/07/21 03:55:46 ron Exp
} {
    {version_id:integer}
}
...
doc_body_append "[apm_header [list "version-view.tcl?version_id=$version_id" "$package_name $version_name"] [list "version-files.tcl?version_id=$version_id" "Files"] "Scan Filesystem"]
<ul>
"
...
<a href=\"version-files.tcl?version_id=$version_id\">Return to the Package Manager</a>
