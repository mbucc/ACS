# /www/intranet/offices/link-ae.tcl
...
ad_page_contract {
    ...
    @cvs-id link-ae.tcl,v 3.6.2.8 2001/01/12 08:32:18 khy Exp
} {
...
set context_bar [ad_context_bar_ws [list ./ "Offices"] [list "view?[export_url_vars group_id]" "One office"] $page_title]

set page_body "
<form method=post action=link-ae-2>
