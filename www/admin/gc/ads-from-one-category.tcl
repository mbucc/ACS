# $Id: ads-from-one-category.tcl,v 3.1 2000/03/11 00:45:10 curtisg Exp $
set_the_usual_form_variables

# domain_id, primary_category

set db [gc_db_gethandle]
set selection [ns_db 1row $db "select domain, full_noun from ad_domains where domain_id = $domain_id"]
