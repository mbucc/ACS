...
set thumbnail_width [ad_parameter ThumbnailWidth "general-portraits"]
set thumbnail_height [ad_parameter ThumbnailHeight "general-portraits"]
set convert_bin [ad_parameter ConvertBinary "general-portraits"]
set produce_thumbnail_p [ad_parameter ProduceThumbnailsAutomaticallyP "general-portraits"]
...
&& ($portrait_original_width < $thumbnail_width && $portrait_original_height < $thumbnail_height)} {
...
if { [exists_and_not_null return_url] } {
    ...
    ad_returnredirect "index?user_id=$user_id"
}
