# $Id: post-edit-2.tcl,v 3.0.4.1 2000/04/28 15:08:26 carsten Exp $
# File:     admin/calendar/post-edit-2.tcl
# Date:     1998-11-18
# Contact:  philg@mit.edu, ahmeds@arsdigita.com
# Purpose:  calendar item edit target page
...
if [catch { ns_db dml $db "update calendar
set category_id = $category_id, title='$QQtitle', 
body='$QQbody', html_p='$html_p',
start_date = '$start_date', end_date = to_date('$end_date  11:59:59', 'YYYY-MM-DD HH24:MI:SS'), 
expiration_date= to_date('$end_date  11:59:59', 'YYYY-MM-DD HH24:MI:SS')+[ad_parameter DaysFromEndToExpiration calendar 3],
event_url = [ns_dbquotevalue $event_url text], 
event_email = [ns_dbquotevalue $event_email text], 
country_code = [ns_dbquotevalue $country_code text], 
usps_abbrev = [ns_dbquotevalue $usps_abbrev text], 
zip_code = [ns_dbquotevalue $zip_code text]
