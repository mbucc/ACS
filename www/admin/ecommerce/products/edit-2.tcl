# /www/admin/ecommerce/products/edit-2.tcl
ad_page_contract {
...
[ad_admin_context_bar [list "../" "Ecommerce"] [list "index" "Products"] [list "one?[export_url_vars product_id]" $product_name] "Edit Product"]
<hr>
