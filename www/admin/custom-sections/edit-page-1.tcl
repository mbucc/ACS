# $Id: edit-page-1.tcl,v 3.0 2000/02/06 03:16:11 ron Exp $
...
[ad_scope_admin_context_bar [list "index.tcl?[export_url_scope_vars section_id]" $section_pretty_name] [list "edit-page.tcl?[export_url_scope_vars content_file_id section_id]" "$file_name Property"] $page_title]
...
<form method=post action=\"edit-page-2.tcl\">
