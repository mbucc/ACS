# $Id: spam-item.tcl,v 3.0 2000/02/06 03:46:13 ron Exp $
# File:     /groups/admin/group/spam-item.tcl
...
ns_write "
[ad_scope_admin_header "One Spam" $db]
[ad_scope_admin_page_title "One Spam" $db]
[ad_scope_admin_context_bar [list "spam-index.tcl" "Spam Admin"] [list "spam-history.tcl" "History"] "One Spam"]
<hr>
"

set selection [ns_db 0or1row  $db "select gsh.*, first_names, last_name, email 
...
if { $approved_p == "t" } {
    ...
    set status_string "Disapproved [ad_space 1] 
        \[<a href=\"spam-approve.tcl?[export_url_vars spam_id]&approved_p=t\">approve</a>\]"
} else {
    set status_string "Waiting for Approval [ad_space 1] 
        \[<a href=\"spam-approve.tcl?[export_url_vars spam_id]&approved_p=t\">approve</a> | 
          <a href=\"spam-approve.tcl?[export_url_vars spam_id]&approved_p=f\">disapprove</a>\]"
}
