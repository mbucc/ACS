...
proc_doc calendar_convert_julian_to_ansi { julian_date } "Return an ANSI date for a Julian date" {
    ...
    set output [db_string julian_date_trunc "select trunc(to_date(:julian_date, 'J')) from dual"]
...
proc day_view {current_date logged_in_user_id group_id {compress_day_view_p "f"} {begin_cal_hour 0} {end_cal_hour 23}} {
	...
	if {[exists_and_not_null title]} {
		...
		<img border=0 width=16 height=16 src=\"/graphics/trash.gif\" alt=\"DELETE\"></a>
		"
	    }
