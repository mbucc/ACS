# $Id: add-complete-css.tcl,v 3.0 2000/02/06 03:16:23 ron Exp $
# File:     /admin/display/add-complete-css.tcl
# Date:     12/26/99
# Author:   ahmeds@arsdigita.com
# Purpose:  adds new style selector
#
...
set page_title "Add New Style Selector "
...
append html "
<form method=post action=\"add-complete-css-2.tcl\">
...
<tr>
<td>Selector 
<td><input type=text name=selector size=20>[ad_space 5](eg. H1)
</tr>
