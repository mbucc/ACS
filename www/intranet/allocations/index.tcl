# $Id: index.tcl,v 3.1.4.1 2000/03/17 08:22:47 mbryzek Exp $
# File: /www/intranet/allocations/index.tcl
#
...
nvl(available_view.percentage_time,0) as percentage,
nvl(scheduled_view.percentage_time,0) as scheduled_percentage
