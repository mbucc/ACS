# $Id: categories-upload.tcl,v 3.0 2000/02/06 03:19:48 ron Exp $
...
# because some data is really nasty with lots of different formats for similar categories.  Maybe loose matching 
# should be an option.
#
# If a subcategory match is found, the product is placed into the matching subcategory as well as the parent category  
# of the matching subcategory. If no match is found for a product, no mapping entry is made.  A product id may 
# appear on multiple lines to place a product in multiple categories.

ReturnHeaders

ns_write "[ad_admin_header "Upload Category Mapping Data"]
...
<form enctype=multipart/form-data action=categories-upload-2.tcl method=post>
