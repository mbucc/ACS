...
foreach subcategory $subcategory_list {
    ad_audit_delete_row [list $subcategory] [list subcategory_id] ec_subcat_prod_map_audit
}
...
foreach subcategory $subcategory_list {
    ad_audit_delete_row [list $subcategory] [list subcategory_id] ec_subcategories_audit
}
...
ad_audit_delete_row [list $category_id] [list category_id] ec_category_product_map_audit
...
ad_audit_delete_row [list $category_id] [list category_id] ec_categories_audit
