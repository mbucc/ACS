# $Id: spam-confirm.tcl,v 3.2 2000/03/09 10:46:32 hqm Exp $
...
ns_write "
[ad_scope_admin_header "Confirm Spamming Group $sendto_string" $db]
[ad_scope_admin_page_title "Confirm Spamming Group $sendto_string" $db]
[ad_scope_admin_context_bar [list "spam-index.tcl" "Spam Admin"] \
	[list "spam.tcl?[export_url_vars sendto]"  "Spam $sendto_string"] Confirm] 
<hr>
"
