# /www/admin/ecommerce/orders/gift-certificates-issued.tcl
ad_page_contract {
...
[ad_admin_context_bar [list "../" "Ecommerce"] [list "index" "Orders"] "Gift Certificate Issue History"]
...
<td>[ec_decode $last_name "" "&nbsp;" "<a href=\"/admin/users/one?user_id=$issued_by\">$last_name, $first_names</a>"]</td>
<td>[ec_decode $last_name "" "&nbsp;" "<a href=\"/admin/users/one?user_id=$issued_to\">$issued_to_last_name, $issued_to_first_names</a>"]</td>
