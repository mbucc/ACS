# $Id: domain-add-2.tcl,v 3.1 2000/03/10 23:58:49 curtisg Exp $
...
if { ![info exists domain_id] || [valid_number_p $domain_id] } {
    incr exception_count
    append exception_text "<li>Please have a valid domain ID."
}
...
# delete and edit ads
ns_db dml $db "declare begin administration_group_add('Admin group for the $QQdomain classifieds', 'gc', '$QQdomain', 'f'); end;"
