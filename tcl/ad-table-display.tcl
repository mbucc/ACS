# $Id: ad-table-display.tcl,v 3.2.4.1 2000/04/28 15:08:14 carsten Exp $
# This is the table, dimensional bar and sort tools.
#
# an example of their use can be found in /tools/ad-table-display-example.txt
#
...
proc_doc ad_dimensional {option_list {url {}} {options_set ""} {optionstype url}} {
    ...
    <ul>
      ...
      <li> url -- url target for select (if blank we set it to ns_conn url).
...
proc_doc ad_dimensional_set_variables {option_list {options_set ""}} {
    ...
    (form defaults to ns_conn form) or to default value from option_list if 
...
ad_proc ad_table { 
    ...
    Tdb selection Tdatadef
} {
    Note: all the variables in this function are named Tblah (except selection for
    the obvious reasons) since otherwise we cannot safely call
    set_variables_from_query since we could potentially have namespace collisions
    <p>
    build and return an html fragment given an active query and a data definition.
    <ul> 
    <li> Tdb and selection -- variables for an active query
...
proc_doc ad_table_form {datadef {type select} {return_url {}} {item_group {}} {item {}} {columns {}} {allowed {}}} {
    ...
    if {![empty_string_p $item]} {
        ...
        append html "<form method=get action=\"/tools/table-custom.tcl\">"
...
proc_doc ad_table_sort_form {datadef {type select} {return_url {}} {item_group {}} {item {}} {sort_spec {}} {allowed {}}} {
    ...
    if {![empty_string_p $item]} {
        append html "<h2>Editing <strong>$item</strong></h2>"
        append html "<form method=get action=\"/tools/sort-custom.tcl\">"
...
proc_doc ad_custom_load {db user_id item_group item item_type} {
...
proc_doc ad_custom_list {db user_id item_group item_set item_type target_url custom_url {new_string "new view"}} {
...
proc_doc ad_custom_form {return_url item_group item} { 
    ...
    append html "<form method=get action=\"/tools/form-custom.tcl\">\n" 
    if {![empty_string_p $return_url]} {
        append html "[export_form_vars return_url]\n"
    }
    if {[empty_string_p $item_group]} {
