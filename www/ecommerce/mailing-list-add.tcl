...
set return_url "[ad_parameter EcommercePath ecommerce]mailing-list-add-2?[export_url_vars category_id subcategory_id subsubcategory_id]"
...
set user_name [db_string get_user_name "select first_names || ' ' || last_name as user_name from users where user_id=:user_id"]
