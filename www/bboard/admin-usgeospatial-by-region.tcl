# $Id: admin-usgeospatial-by-region.tcl,v 3.0 2000/02/06 03:33:24 ron Exp $
...
while { [ns_db getrow $db $selection] } {
	...
	append region_text "<li><a href=\"usgeospatial-2.tcl?[export_url_vars topic epa_region]\">Region $epa_region</a>: <b>$description</b> ("
    }
