# /www/intranet/offices/link-ae-2.tcl
...
ad_page_contract {
    ...
    @cvs-id link-ae-2.tcl,v 3.2.6.10 2001/01/12 08:32:17 khy Exp
} {
    dp.im_office_links.link_id:integer
    link_id:naturalnum,notnull,verify
...
set dp.im_office_Links.link_id $link_id
