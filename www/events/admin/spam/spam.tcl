# spam.tcl,v 1.1.2.2 2000/02/03 09:50:04 ron Exp
# spam.tcl
#
# hqm@arsdigita.com
#
...
if {[empty_string_p $subject] && [empty_string_p $message] && [empty_string_p $message_html] && [empty_string_p $message_aol]} {
...
returning body_plain, body_html, body_aol into :1, :2, :3" $message $message_html $message_aol } errmsg] {
...
[ad_context_bar_ws [list "../index.tcl" "Events Administration"]  "Spam Execution"]
...
<li>body: <blockquote><pre>$message</pre></blockquote>
