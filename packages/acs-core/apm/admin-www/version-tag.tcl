ad_page_contract { 
    ...
    @date 9 May 2000
    @cvs-id version-tag.tcl,v 1.5.2.3 2000/07/21 03:55:48 ron Exp
} {
    {version_id:integer}
}
...
doc_body_append "[apm_header [list "version-view.tcl?version_id=$version_id" "$package_name $version_name"] [list "version-files.tcl?version_id=$version_id" "Files"] "Tag"]
