...
--       "Can user x do y?"
--
-- $Id: user-groups.sql,v 3.6.2.1 2000/03/15 09:36:44 michael Exp $
--
...
create table user_group_type_fields (
	group_type	not null references user_group_types,
...
begin
 ...
 if n_system_group_types = 0 then 
   ...
   values
     ('administration', 'Administration', 'Administration Groups', 'closed', 'closed', 'full');
