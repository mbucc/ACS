# $Id: post-new-4.tcl,v 3.0.4.1 2000/04/28 15:09:49 carsten Exp $
# File:     /calendar/admin/post-new-4.tcl
# Date:     1998-11-18
# Contact:  philg@mit.edu, ahmeds@arsdigita.com
# Purpose:  actually do the insert into the calendar table
#
...
country_code, usps_abbrev, zip_code, [ad_scope_cols_sql])
values
...
[ns_dbquotevalue $country_code text],[ns_dbquotevalue $usps_abbrev text],[ns_dbquotevalue $zip_code text], [ad_scope_vals_sql])" } errmsg] {
...
[ad_scope_admin_header "Thank you" $db]
<h2>Thank you</h2>
for your submission to <a href=\"index.tcl?[export_url_scope_vars]\">[ad_parameter SystemName calendar "Calendar"]</a>
