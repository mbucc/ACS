# admin/pdm/pdm-edit-2.tcl
#
# Author: aure@caltech.edu, Feb 2000
#
# $Id: pdm-edit-2.tcl,v 1.1.2.2 2000/04/28 15:09:19 carsten Exp $
# -----------------------------------------------------------------------------
...
ns_db dml $db "
    update pdm_menus
        set menu_key    = '[DoubleApos $menu_key]',
        default_p      = '$default_p',
        ...
        main_menu_font_style    = [ns_dbquotevalue $main_menu_font_style    string],
        sub_menu_font_style     = [ns_dbquotevalue $sub_menu_font_style     string],
        sub_sub_menu_font_style = [ns_dbquotevalue $sub_sub_menu_font_style string],
        main_menu_bg_img_url    = [ns_dbquotevalue $main_menu_bg_img_url    string],
        main_menu_bg_color      = [ns_dbquotevalue $main_menu_bg_color      string],
        main_menu_hl_img_url    = [ns_dbquotevalue $main_menu_hl_img_url    string],
        main_menu_hl_color      = [ns_dbquotevalue $main_menu_hl_color      string],
        sub_menu_bg_img_url     = [ns_dbquotevalue $sub_menu_bg_img_url     string],
        sub_menu_bg_color       = [ns_dbquotevalue $sub_menu_bg_color       string],
        sub_menu_hl_img_url     = [ns_dbquotevalue $sub_menu_hl_img_url     string],
        sub_menu_hl_color       = [ns_dbquotevalue $sub_menu_hl_color       string],
        sub_sub_menu_bg_img_url = [ns_dbquotevalue $sub_sub_menu_bg_img_url string],
        sub_sub_menu_bg_color   = [ns_dbquotevalue $sub_sub_menu_bg_color   string],
        sub_sub_menu_hl_img_url = [ns_dbquotevalue $sub_sub_menu_hl_img_url string],
        sub_sub_menu_hl_color   = [ns_dbquotevalue $sub_sub_menu_hl_color   string]
