ad_library {
    ...
    @cvs-id widgets-procs.tcl,v 1.3.2.8 2000/07/22 08:42:24 yon Exp
}
...
## teadams - use db_html_select_options or db_html_select_value_options
## instead of ad_db_optionlist

ad_proc -deprecated ad_db_optionlist {
    {
	-bind {}
    } 
    statement_name sql {default ""}} {
	...
	db_foreach $statement_name $sql -bind $bind -column_set selection {
