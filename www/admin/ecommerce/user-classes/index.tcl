#  www/admin/ecommerce/user-classes/index.tcl
ad_page_contract {
...
db_foreach get_uc_info_lines "select 
...
order by user_class_name" {
	...
	set n_approved_users [db_string get_n_approved_users "select 
...
<ul>
<li><a href=\"/admin/ecommerce/audit-tables?[export_url_vars table_names_and_id_column]\">Audit All User Classes</a>
</ul>
