# $Id: post-message.tcl,v 3.0.4.1 2000/04/28 15:09:52 carsten Exp $
# File:     /chat/post-message.tcl
# Date:     1998-11-18
...
if { ![info exists QQmsg] || [empty_string_p $QQmsg] } {
    ad_returnredirect chat.tcl?[export_url_scope_vars chat_room_id n_rows]
    return
}

chat_post_message $db $QQmsg $user_id $chat_room_id
