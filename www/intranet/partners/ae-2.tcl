# $Id: ae-2.tcl,v 3.2.2.2 2000/04/28 15:11:09 carsten Exp $
# File: /www/intranet/partners/ae-2.tcl
#
# Author: mbryzek@arsdigita.com, Jan 2000
# 
# Purpose: Stores partner info in db
#
...
if { $exists_p } {
    incr exception_count
    append errors "  <li> The specified short name already exists. Either choose a new name or go back to the partner's page to edit the existing record\n"
}
...
if { ![exists_and_not_null return_url] } {
    set return_url [im_url_stub]/partners/view.tcl?[export_url_vars group_id]
}
