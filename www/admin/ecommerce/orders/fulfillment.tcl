# /www/admin/ecommerce/orders/fulfillment.tcl
ad_page_contract {
...
[ad_admin_context_bar [list "../" "Ecommerce"] [list "index" "Orders"] "Fulfillment"]
...
db_foreach orders_select "select o.order_id, o.confirmed_date, o.order_state, o.shipping_method, u.first_names, u.last_name, u.user_id
