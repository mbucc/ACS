...
set context_bar [ad_context_bar_ws [list "[im_url_stub]/reports/" "Reports"] "Project Utilization Report"]
...
select u.last_name || ', ' || u.first_names as name, u.email, u.user_id, 
  ...
  from users u, im_employee_info info, user_groups ug, im_projects proj, im_jobs, im_departments
