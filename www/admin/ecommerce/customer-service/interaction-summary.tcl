...
if { [info exists user_id] } {
    append doc_body "Registered user: <a href=\"/admin/users/one?user_id=$user_id\">[db_string get_full_name "select first_names || ' ' || last_name from users where user_id=:user_id"]</a>"
} else {
...
db_foreach get_interaction_summary $sql {
	...
	<table>
	<tr><td align=right><b>Rep</td><td><a href=\"/admin/users/one?user_id=$customer_service_rep\">$rep_name</a></td></tr>
