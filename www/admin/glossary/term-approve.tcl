# $Id: term-approve.tcl,v 3.0.4.1 2000/04/28 15:09:07 carsten Exp $
if {[ad_read_only_p]} {
...
if { ![info exists term] || [empty_string_p $QQterm]} {
    ...
    append exception_text "<li>You somehow got here without specifying a term to approve."
}
...
if [catch { ns_db dml $db "update glossary 
set approved_p = 't'
