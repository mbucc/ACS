...
ReturnHeaders
ns_write "[ad_header "Waiting Registrations"]
<h2>Waiting Registrations for [events_pretty_event $db $event_id]</h2>
[ad_context_bar_ws [list "index.tcl" "Events Administration"] "Waiting Registrations"]
