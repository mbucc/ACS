# $Id: action-role-unmap.tcl,v 3.0.4.1 2000/04/28 15:10:57 carsten Exp $
# File:     /groups/admin/group/action-role-unmap.tcl
# Date:     mid-1998
# Contact:  teadams@mit.edu, tarik@arsdigita.com
# Purpose:  forbid users with the role $role to do action $action
#
