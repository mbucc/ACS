# $Id: js-message-form.tcl,v 3.0 2000/02/06 03:36:43 ron Exp $
# File:     /chat/js-message-form.tcl
# Date:     1998-11-18
...
<form name=hidden target=chat_rows method=post action=js-message-post-message.tcl>
